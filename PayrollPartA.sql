...
--
-- Q1. Display the full details of employees who earn less than $1000.
SELECT
    empno,
    empname,
    empinit,
...
--
-- Q3. Display the full details of trainers (employee job is TRAINER) who earn 
-- less than 2500 each month and are working in department 20.
...
--
-- Q5. Display the name and job of employees whose job ends with the letter R.
...
--
-- Q6. Display the name and job of employees that have a name starting with 'J','K' or 'M'.
...
--
-- Q7. Display the employees who were born before 1990 and earn more than 1500 each month.
...
--
-- Q8. Display the name, job, date of birth and salary of employees that don't have a commission.
...
--
-- Q9. Display the employee name, job, department name, location and monthly salary 
-- of employees that work in NEW YORK.
...
FROM
    payroll.employee e join payroll.department d on e.deptno = d.deptno
WHERE
        upper(d.deptlocation) NOT IN (
            'NEW YORK','CHICAGO'
        )
ORDER BY e.empname;

--
-- Q11. Display the name, job, date of birth and salary of employees who were born 
-- in the first half of the 70s. Display the output in birth date order.
...
--
-- Q12. Display the name, job and salary of employees who earn less than 1500 or greater than 3000 per month.
...
--
-- Q13. Display the name, job and manger number of employees who have a manager.
...
--
-- Q14. Display the name, job, department name, department location and salary of 
-- employees who either work in DALLAS or as a MANAGER, and earn more than 2500.
